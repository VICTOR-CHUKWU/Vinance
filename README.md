...
> this project is a crypto currency app with react
...
### Setup
clone the repo or download from https://github.com/VICTOR-CHUKWU/Vinance

### Install
install all dependencies with npm install or yarn add 

### Usage
run yarn start or npm start in your terminal to build and serve the files
